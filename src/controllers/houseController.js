...
exports.postCreatedHouse = async (req, res) => {
 const {name, type, year, city, imageUrl, description, prices} = req.body
    ...
    try{
        ...
        const newHouse = new Housing({name, type, year, city, imageUrl, description, prices, owner: req.user._id})//encoded body-to, which we receive, will create a new cube
        //save newhoouse
...
const pieces = currentHouse.prices
